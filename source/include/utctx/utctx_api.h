...
typedef enum _UtopiaValue
{
    ...
    UtopiaValue_LGFW_V4IpFilter,
    UtopiaValue_LGFW_V4IpFilter_InsNum,
    UtopiaValue_LGFW_V4IpFilter_Alias,
    UtopiaValue_LGFW_V4IpFilter_Desc,
    UtopiaValue_LGFW_V4IpFilter_Enable,
    UtopiaValue_LGFW_V4IpFilter_SrcStartIp,
    UtopiaValue_LGFW_V4IpFilter_SrcEndIp,
    UtopiaValue_LGFW_V4IpFilter_DstStartIp,
    UtopiaValue_LGFW_V4IpFilter_DstEndIp,
    UtopiaValue_LGFW_V4IpFilter_SrcStartPort,
    UtopiaValue_LGFW_V4IpFilter_SrcEndPort,
    UtopiaValue_LGFW_V4IpFilter_DstStartPort,
    UtopiaValue_LGFW_V4IpFilter_DstEndPort,
    UtopiaValue_LGFW_V4IpFilter_ProtoType,
    UtopiaValue_LGFW_V4IpFilter_Action,
    UtopiaValue_LGFW_V4IpFilter_Direction,
    UtopiaValue_LGFW_V6IpFilterCount,
    UtopiaValue_LGFW_V6IpFilter,
    UtopiaValue_LGFW_V6IpFilter_InsNum,
    UtopiaValue_LGFW_V6IpFilter_Alias,
    UtopiaValue_LGFW_V6IpFilter_Desc,
    UtopiaValue_LGFW_V6IpFilter_SrcStartIp,
    UtopiaValue_LGFW_V6IpFilter_SrcStartPort,
    UtopiaValue_LGFW_V6IpFilter_SrcEndPort,
    UtopiaValue_LGFW_V6IpFilter_ProtoType,
    UtopiaValue_LGFW_V6IpFilter_Action,
    UtopiaValue_LGFW_V6IpFilter_DstStartIp,
    UtopiaValue_LGFW_V6IpFilter_DstStartPort,
    UtopiaValue_LGFW_V6IpFilter_DstEndPort,
    UtopiaValue_LGFW_V6IpFilter_IPv6SrcPrefixLen,
    UtopiaValue_LGFW_V6IpFilter_IPv6DstPrefixLen,
    UtopiaValue_LGFW_V6IpFilter_Enable,
    UtopiaValue_LGFW_V6IpFilter_FilterDirec,
    UtopiaValue_LGFW_MACFilterCount,
    UtopiaValue_LGFW_MACFilter,
    UtopiaValue_LGFW_MACFilter_InsNum,
    UtopiaValue_LGFW_MACFilter_Alias,
    ...
    UtopiaValue_LGFW_V4DayOfWeek_Alias,
    UtopiaValue_LGFW_V4DayOfWeek_BlockTimeBitMask,
    UtopiaValue_LGFW_V6DayOfWeekCount,
    UtopiaValue_LGFW_V6DayOfWeek,
    UtopiaValue_LGFW_V6DayOfWeek_InsNum,
    UtopiaValue_LGFW_V6DayOfWeek_Alias,
    UtopiaValue_LGFW_V6DayOfWeek_BlockTimeBitMask,
    UtopiaValue_LGFW_MacDayOfWeekCount,
    UtopiaValue_LGFW_MacDayOfWeek,
