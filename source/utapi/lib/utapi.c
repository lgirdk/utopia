...
int Utopia_SetFirewallSettings (UtopiaContext *ctx, firewall_t fw)
{
     ...
     int rule_count = 0;
     FALSE == fw.allow_ipsec_passthru?
        setFWBlockingRule(ctx, ++rule_count, s_blockipsec, "ipsec", "DROP") : setFWBlockingRule(ctx, ++rule_count, s_blockipsec, "ipsec", "ACCEPT");

     FALSE == fw.allow_pptp_passthru?
        setFWBlockingRule(ctx, ++rule_count, s_blockpptp, "pptp", "DROP") : setFWBlockingRule(ctx, ++rule_count, s_blockpptp, "pptp", "ACCEPT");

     FALSE == fw.allow_l2tp_passthru?
        setFWBlockingRule(ctx, ++rule_count, s_blockl2tp, "l2tp", "DROP") : setFWBlockingRule(ctx, ++rule_count, s_blockl2tp, "l2tp", "ACCEPT");

     FALSE == fw.allow_ssl_passthru?
        setFWBlockingRule(ctx, ++rule_count, s_blockssl, "ssl", "DROP") : setFWBlockingRule(ctx, ++rule_count, s_blockssl, "ssl", "ACCEPT");
...
static int s_getportfwd (UtopiaContext *ctx, int index, portFwdSingle_t *portmap)
{
    ...
    Utopia_GetIndexed(ctx, UtopiaValue_SPF_Interface, index, portmap->interface, NAME_SZ);
...
//    Utopia_GetIndexedInt(ctx, UtopiaValue_SPF_ToIp, index, &portmap->dest_ip);
    ...
    Utopia_GetIndexed(ctx, UtopiaValue_SPF_Alias, index, portmap->alias, sizeof(portmap->alias));
...
//    UTOPIA_SETINDEXEDINT(ctx, UtopiaValue_SPF_ToIp, index, portmap->dest_ip);
    ...
    UTOPIA_SETINDEXED(ctx, UtopiaValue_SPF_Interface, index, portmap->interface);
    UTOPIA_SETINDEXED(ctx, UtopiaValue_SPF_Alias, index, portmap->alias);
...
static int s_getportfwdrange (UtopiaContext *ctx, int index, portFwdRange_t *portmap)
{
    ...
    Utopia_GetIndexed(ctx, UtopiaValue_PFR_Interface, index, portmap->interface, NAME_SZ);
    ...
    Utopia_GetIndexed(ctx, UtopiaValue_PFR_Alias, index, portmap->alias, sizeof(portmap->alias));
...
static int s_setportfwdrange (UtopiaContext *ctx, int index, portFwdRange_t *portmap)
{
    ...
    UTOPIA_SETINDEXED(ctx, UtopiaValue_PFR_Interface, index, portmap->interface);
    UTOPIA_SETINDEXED(ctx, UtopiaValue_PFR_Alias, index, portmap->alias);
...
static int _check_port_filter_range(UtopiaContext *ctx, int new_rule_id, int new_start, int new_end, char *new_protocol, int is_filter)
{
    if (is_filter != 1)
    {
        new_rule_id = 0;
...
static int _check_port_internal_range(UtopiaContext *ctx, int new_rule_id, int new_start, int new_end, int new_protocol, UtopiaValue utopia[6], unsigned long new_ip, int is_trigger)
{
    int (*get_ruleid_func)(UtopiaContext *ctx, int index);
...
int Utopia_SetV4IpFilterByIndex(UtopiaContext *ctx, unsigned long ulIndex, const fwipfilter_t *ipFilter)
{
    ...
    snprintf(tokenbuf, sizeof(tokenbuf), "lgfwv4if_%d", index);
    Utopia_SetIndexed(ctx, UtopiaValue_LGFW_V4IpFilter, index, tokenbuf);
...
int Utopia_SetV6IpFilterByIndex(UtopiaContext *ctx, unsigned long ulIndex, const fwipfilter_t *ipFilter)
{
    ...
    snprintf(tokenbuf, sizeof(tokenbuf), "lgfwv6if_%d", index);
    Utopia_SetIndexed(ctx, UtopiaValue_LGFW_V6IpFilter, index, tokenbuf);
...
int Utopia_SetMACFilterByIndex(UtopiaContext *ctx, unsigned long ulIndex, const fwmacfilter_t *MACFilter)
{
    ...
    snprintf(tokenbuf, sizeof(tokenbuf), "lgfwmac_%d", index);
    Utopia_SetIndexed(ctx, UtopiaValue_LGFW_MACFilter, index, tokenbuf);
...
int Utopia_SetV4DayOfWeekByIndex(UtopiaContext *ctx, unsigned long ulIndex, const fwv4dayofweek_t *V4DayOfWeek)
{
    ...
    snprintf(tokenbuf, sizeof(tokenbuf), "lgfwv4dayofweek_%d", ulIndex);
    Utopia_SetIndexed(ctx, UtopiaValue_LGFW_V4DayOfWeek, ulIndex, tokenbuf);
...
int Utopia_SetV6DayOfWeekByIndex(UtopiaContext *ctx, unsigned long ulIndex, const fwv6dayofweek_t *V6DayOfWeek)
{
    ...
    snprintf(tokenbuf, sizeof(tokenbuf), "lgfwv6dayofweek_%d", ulIndex);
    Utopia_SetIndexed(ctx, UtopiaValue_LGFW_V6DayOfWeek, ulIndex, tokenbuf);
...
int Utopia_SetMacDayOfWeekByIndex(UtopiaContext *ctx, unsigned long ulIndex, const fwmacdayofweek_t *MacDayOfWeek)
{
    ...
    snprintf(tokenbuf, sizeof(tokenbuf), "lgfwmacdayofweek_%d", ulIndex);
    Utopia_SetIndexed(ctx, UtopiaValue_LGFW_MacDayOfWeek, ulIndex, tokenbuf);
...
int Utopia_SetLanAllowedSubnetByIndex(UtopiaContext *ctx, unsigned long ulIndex, const lanAllowedSubnet_t *LanAllowedSubnet)
{
    ...
    snprintf(tokenbuf, sizeof(tokenbuf), "arLanAllowedSubnet_%d", index);
    Utopia_SetIndexed(ctx, UtopiaValue_LanAllowedSubnet, index, tokenbuf);
...
int Utopia_SetNATPassthroughByIndex(UtopiaContext *ctx, unsigned long ulIndex, const fwNATPassthrough_t *NATPassthrough)
{
    ...
    snprintf(tokenbuf, sizeof(tokenbuf), "arfwnat_%d", index);
    Utopia_SetIndexed(ctx, UtopiaValue_NATPassthrough, index, tokenbuf);
